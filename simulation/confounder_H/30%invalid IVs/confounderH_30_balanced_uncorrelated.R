...
input_file=c(
   "confounder_Hdim=1_balanced_uncorrelated_pleiotropy30.RData",
   "confounder_Hdim=2_balanced_uncorrelated_pleiotropy30.RData",
   "confounder_Hdim=4_balanced_uncorrelated_pleiotropy30.RData"
)
