setwd("/panfs/jay/groups/20/panwei/wan01299/paper2/simulation/confounder_H/30%invalid/")
N_non_null=40
N_H_only=40
N_null=3000
DP=100
...
input_file=c(
   "confounder_Hdim=1_directional_uncorrelated_pleiotropy30.RData",
   "confounder_Hdim=2_directional_uncorrelated_pleiotropy30.RData",
   "confounder_Hdim=4_directional_uncorrelated_pleiotropy30.RData"
)
