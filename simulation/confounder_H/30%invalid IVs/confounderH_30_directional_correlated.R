...
input_file=c(
  "confounder_Hdim=1_directional_correlated_pleiotropy30.RData",
  "confounder_Hdim=2_directional_correlated_pleiotropy30.RData",
  "confounder_Hdim=4_directional_correlated_pleiotropy30.RData" 
)
