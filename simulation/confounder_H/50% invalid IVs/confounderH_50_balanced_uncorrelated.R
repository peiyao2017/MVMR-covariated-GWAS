...
input_file=c(
  "confounder_Hdim=1_balanced_uncorrelated_pleiotropy50.RData",
  "confounder_Hdim=2_balanced_uncorrelated_pleiotropy50.RData",
  "confounder_Hdim=4_balanced_uncorrelated_pleiotropy50.RData" 
)
...
for(i in 1:DP){
  ...
  est_mv_cml_no_adj=MVmr_cML(b_exp =data_mv_no_adj[,1:(ncol(data_mv_no_adj)-1)],b_out =as.matrix(data_mv_no_adj[,ncol(data_mv_no_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_no_adj,Sig_inv_l = SIG_inv_no_adjust,n=sample_size,K_vec =c(0:(N_non_null-d-2)),random_start = d+1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04   )
  est_mv_cml_X_adj=MVmr_cML(b_exp =data_mv_X_adj[,1:(ncol(data_mv_X_adj)-1)],b_out =as.matrix(data_mv_X_adj[,ncol(data_mv_X_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_adj,Sig_inv_l = SIG_inv_X_adjust,n=sample_size,K_vec =c(0:(N_non_null-d-2)),random_start = d+1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04   )
  est_mv_cml_Y_adj=MVmr_cML(b_exp =data_mv_Y_adj[,1:(ncol(data_mv_Y_adj)-1)],b_out =as.matrix(data_mv_Y_adj[,ncol(data_mv_Y_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_adj,Sig_inv_l = SIG_inv_Y_adjust,n=sample_size,K_vec =c(0:(N_non_null-d-2)),random_start = d+1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04   )
  est_mv_cml_X_and_Y_adj=MVmr_cML(b_exp =data_mv_X_and_Y_adj[,1:(ncol(data_mv_X_and_Y_adj)-1)],b_out =as.matrix(data_mv_X_and_Y_adj[,ncol(data_mv_X_and_Y_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_adj,Sig_inv_l = SIG_inv_X_and_Y_adjust,n=sample_size,K_vec =c(0:(N_non_null-d-2)),random_start = d+1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04   )
  est_uv_cml_no_adj=MVmr_cML(b_exp =as.matrix(data_uv_no_adj[,1:(ncol(data_uv_no_adj)-1)],nrow=N_non_null,ncol=1),b_out =as.matrix(data_uv_no_adj[,ncol(data_uv_no_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_no_adj,Sig_inv_l = SIG_inv_uv_no_adjust,n=sample_size,K_vec =c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04   )
  est_uv_cml_X_adj=MVmr_cML(b_exp =as.matrix(data_uv_X_adj[,1:(ncol(data_uv_X_adj)-1)],nrow=N_non_null,ncol=1),b_out =as.matrix(data_uv_X_adj[,ncol(data_uv_X_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_adj,Sig_inv_l = SIG_inv_uv_X_adjust,n=sample_size,K_vec =c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04   )
  est_uv_cml_Y_adj=MVmr_cML(b_exp =as.matrix(data_uv_Y_adj[,1:(ncol(data_uv_Y_adj)-1)],nrow=N_non_null,ncol=1),b_out =as.matrix(data_uv_Y_adj[,ncol(data_uv_Y_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_adj,Sig_inv_l = SIG_inv_uv_Y_adjust,n=sample_size,K_vec =c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04  )
  est_uv_cml_X_and_Y_adj=MVmr_cML(b_exp =as.matrix(data_uv_X_and_Y_adj[,1:(ncol(data_uv_X_and_Y_adj)-1)],nrow=N_non_null,ncol=1),b_out =as.matrix(data_uv_X_and_Y_adj[,ncol(data_uv_X_and_Y_adj)],nrow=N_non_null,ncol=1),se_bx =se_exp_adj,Sig_inv_l = SIG_inv_uv_X_and_Y_adjust,n=sample_size,K_vec =c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04  )
...
if(d==1){
  ...
  for(i in 1:DP){
    ...
    theta_corrected_cml_cml_DP[i,]=MVmr_cML(b_exp=as.matrix(X_DP_cml),b_out =as.matrix(Y_DP_cml),se_bx = as.matrix(seX_cml),Sig_inv_l = SIGinv_cml,n=sample_size,K_vec = c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04 )$BIC_theta
  }
  ...
  for(i in 1:DP){
    ...
    theta_corrected_cml_ivw_DP[i,]=MVmr_cML(b_exp=as.matrix(X_DP_ivw),b_out =as.matrix(Y_DP_ivw),se_bx = as.matrix(seX_ivw),Sig_inv_l = SIGinv_ivw,n=sample_size,K_vec = c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04 )$BIC_theta
  }
  ...
  for(i in 1:DP){
    ...
    theta_corrected_cml_dho_DP[i,]=MVmr_cML(b_exp=as.matrix(X_DP_dho),b_out =as.matrix(Y_DP_dho),se_bx = as.matrix(seX_dho),Sig_inv_l = SIGinv_dho,n=sample_size,K_vec = c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04 )$BIC_theta
  }
  ...
  for(i in 1:DP){
    ...
    theta_corrected_cml_sh_DP[i,]=MVmr_cML(b_exp=as.matrix(X_DP_sh),b_out =as.matrix(Y_DP_sh),se_bx = as.matrix(seX_sh),Sig_inv_l = SIGinv_sh,n=sample_size,K_vec = c(0:(N_non_null-2)),random_start = 1,min_theta_range = 0.4,max_theta_range = 0.4,thres = 0.04 )$BIC_theta
  }
