...
input_file=c(
  "confounder_Hdim=1_directional_uncorrelated_pleiotropy50.RData",
  "confounder_Hdim=2_directional_uncorrelated_pleiotropy50.RData",
  "confounder_Hdim=4_directional_uncorrelated_pleiotropy50.RData" 
)
