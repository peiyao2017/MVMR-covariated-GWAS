...
input_file=c(
  "mediator_Hdim=1_balanced_uncorrelated_pleiotropy50.RData",
  "mediator_Hdim=2_balanced_uncorrelated_pleiotropy50.RData",
  "mediator_Hdim=4_balanced_uncorrelated_pleiotropy50.RData" 
)
