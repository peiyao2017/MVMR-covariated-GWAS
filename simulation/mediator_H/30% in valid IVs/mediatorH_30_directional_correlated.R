...
input_file=c(
  "mediator_Hdim=1_directional_correlated_pleiotropy30.RData",
  "mediator_Hdim=2_directional_correlated_pleiotropy30.RData",
  "mediator_Hdim=4_directional_correlated_pleiotropy30.RData" 
)
