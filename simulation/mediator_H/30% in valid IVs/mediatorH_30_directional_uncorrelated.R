setwd("/panfs/jay/groups/20/panwei/wan01299/paper2/simulation/mediator_H/30%invalid/")
N_non_null=40
N_H_only=40
N_null=3000
DP=100
...
input_file=c(
  "mediator_Hdim=1_directional_uncorrelated_pleiotropy30.RData",
  "mediator_Hdim=2_directional_uncorrelated_pleiotropy30.RData",
  "mediator_Hdim=4_directional_uncorrelated_pleiotropy30.RData" 
)
