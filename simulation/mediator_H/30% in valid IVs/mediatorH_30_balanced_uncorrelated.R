...
input_file=c(
  "mediator_Hdim=1_balanced_uncorrelated_pleiotropy30.RData",
  "mediator_Hdim=2_balanced_uncorrelated_pleiotropy30.RData",
  "mediator_Hdim=4_balanced_uncorrelated_pleiotropy30.RData" 
)
